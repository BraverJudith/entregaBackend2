    ...
    static getProduct = async (req, res) => {
        try {
            ...
            res.status(200).render("products", {
                ...
                prevLink: productos.hasPrevPage ? `/api/product?page=${productos.prevPage}&limit=${limit}&sort=${sort}&query=${query}` : null,
                nextLink: productos.hasNextPage ? `/api/product?page=${productos.nextPage}&limit=${limit}&sort=${sort}&query=${query}` : null,
                isAsc: sort === "asc",
                isDesc: sort === "desc",
                user:user,
                cart:user.cart_id
